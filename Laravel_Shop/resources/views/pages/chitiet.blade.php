							...
							<div class="col-sm-4">
								<div class="single-item">
									<div class="single-item-header">
										<a href="chitiet/{{$tt->id}}"><img width="270px" height="250px" src="source/image/product/{{$tt->image}}" alt=""></a>
									</div>
									<div class="single-item-body">
										<p class="single-item-title">{{$tt->name}}</p>
										<p class="single-item-price">
											@if($tt->promotion_price==0)
											<span class="flash-sale">{{number_format($tt->unit_price)}}$</span>
											@else
									...
									<div class="single-item-caption">
										...
										<a class="beta-btn primary" href="chitiet/{{$tt->id}}">Details <i class="fa fa-chevron-right"></i></a>
										<div class="clearfix"></div>
									</div>
								</div>
							</div>
