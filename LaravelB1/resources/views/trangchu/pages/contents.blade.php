...
<!-- Page Content -->
    <div class="container">
    	...
    	@include('trangchu.layout.slides')
					    ...
					    <div class="row-item row">
		                	...
		                	<div class="col-md-8 border-right">
			                    ...
			                    <div class="col-md-7">
			                        <h3>{{$tin1['TieuDe']}}</h3>
			                        <p>{!!$tin1['TomTat']!!}</p>
			                        <a class="btn btn-primary" href="tintuc/{{$tin1['id']}}/{{$tin1['TieuDeKhongDau']}}.html">Xem them <span class="glyphicon glyphicon-chevron-right"></span></a>
								</div>
								@endif
		                	</div>
