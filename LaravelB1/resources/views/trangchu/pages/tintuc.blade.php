        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="col-md-7">
                        <a href="tintuc/{{$tlq->id}}/{{$tlq->TieuDeKhongDau}}.html"><b><i>{{$tlq->TieuDe}}</i></b></a>
                    </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="col-md-7">
                        <a href="tintuc/{{$tnb->id}}/{{$tnb->TieuDeKhongDau}}.html"><b><i>{{$tnb->TieuDe}}</i></b></a>
                    </div>
